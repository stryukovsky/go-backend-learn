...
// AssetList is a free data retrieval call binding the contract method 0xe372f03a.
//
// Solidity: function assetList() view returns(address)
func (_Comet *CometCaller) AssetList(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Comet.contract.Call(opts, &out, "assetList")
...
//
// Solidity: function assetList() view returns(address)
func (_Comet *CometSession) AssetList() (common.Address, error) {
	return _Comet.Contract.AssetList(&_Comet.CallOpts)
}

// AssetList is a free data retrieval call binding the contract method 0xe372f03a.
//
// Solidity: function assetList() view returns(address)
func (_Comet *CometCallerSession) AssetList() (common.Address, error) {
	return _Comet.Contract.AssetList(&_Comet.CallOpts)
}
